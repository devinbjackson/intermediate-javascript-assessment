...
// CODE HERE...
  String.prototype.grammarPolice = function(str){
    var str = this.toString().replace(/\w\S*/g, function(txt){return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase();});
    return str;
  }
...
function valueType(val1, val2){
  if(val1 === val2){return "Exactly the same"}
  else if(val1 == val2){return "Same value, different types"}
